...
export default function FreshCleanCaseStudyModal({ isOpen, onClose }) {
  ...
  return createPortal(
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-2 sm:p-[clamp(0.4rem,2cqh,1rem)] md:p-8 overflow-hidden">
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          <button
            onClick={onClose}
            className="absolute top-2 right-2 md:top-[clamp(0.4rem,2cqh,1rem)] md:right-4 z-[110] p-3 rounded-full bg-[#eaddc5] border border-[#8b7355] text-[#5c4d3c] hover:text-black hover:bg-[#d4b886] transition-all shadow-xl"
            ...
            >
              <Page number={1}>
                <div className="flex flex-col h-full justify-between items-center py-6 text-[#1a1510]">
                  <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col w-full mt-6">
                    ...
                    <p className="text-[clamp(0.5rem,1.5cqh,0.75rem)] font-serif italic text-[#3a2f24] px-4 leading-relaxed text-center">
                  ...
                  <div className="mt-auto pt-16 space-y-3 text-center">
                    <p className="font-['Playfair_Display'] text-[clamp(0.6rem,2cqh,1.125rem)] font-bold">
                      Written by: Abhishek Madar
                    </p>
                    <p className="font-serif text-[clamp(0.5rem,1.5cqh,0.7rem)] text-[#2c241b] italic">
                      Lead Software Engineer & Architect
                    </p>
                    <p className="font-serif text-[clamp(0.5rem,1.5cqh,0.7rem)] text-[#2c241b] mt-4">
              ...
              <Page number={2}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  ...
                  <div className="flex flex-col gap-[clamp(0.2rem,1cqh,0.75rem)] px-[clamp(0.25rem,2cqw,1rem)] mt-[clamp(0.5rem,2cqh,1.5rem)] font-serif text-[#2c241b] text-[clamp(0.45rem,1.8cqh,0.75rem)]">
                    ...
                    <div className="pl-[clamp(0.25rem,2cqw,1rem)] flex flex-col gap-[clamp(0.1rem,0.5cqh,0.125rem)] text-[clamp(0.4rem,1.6cqh,0.625rem)] text-[#5c4d3c]">
                      ...
                      <div className="flex justify-between"><span>2.2 REST API Specification Matrix</span><span>8</span></div>
                    </div>
                    <div className="flex justify-between border-b border-[#8b7355]/10 pb-[clamp(0.1rem,0.5cqh,0.125rem)] pt-[clamp(0.1rem,1cqh,0.5rem)]">
                    ...
                    <div className="pl-[clamp(0.25rem,2cqw,1rem)] flex flex-col gap-[clamp(0.1rem,0.5cqh,0.125rem)] text-[clamp(0.4rem,1.6cqh,0.625rem)] text-[#5c4d3c]">
                      <div className="flex justify-between"><span>3.1 Serverless Lazy Connection Pooling Engine</span><span>9</span></div>
                      <div className="flex justify-between"><span>3.2 Transactional Wallet Sync Engine</span><span>10</span></div>
                    </div>
                    <div className="flex justify-between border-b border-[#8b7355]/10 pb-[clamp(0.1rem,0.5cqh,0.125rem)] pt-[clamp(0.1rem,1cqh,0.5rem)]">
                    ...
                    <div className="pl-[clamp(0.25rem,2cqw,1rem)] flex flex-col gap-[clamp(0.1rem,0.5cqh,0.125rem)] text-[clamp(0.4rem,1.6cqh,0.625rem)] text-[#5c4d3c]">
                      ...
                      <div className="flex justify-between"><span>4.2 Database Execution & Query Benchmarks</span><span>11</span></div>
                      <div className="flex justify-between"><span>4.3 Serverless Execution Metrics</span><span>12</span></div>
                      <div className="flex justify-between"><span>4.4 Frontend Web Vitals Benchmarks</span><span>13</span></div>
                    </div>
                    <div className="flex justify-between border-b border-[#8b7355]/10 pb-[clamp(0.1rem,0.5cqh,0.125rem)] pt-[clamp(0.1rem,1cqh,0.5rem)]">
              ...
              <Page number={3}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  ...
                  <div className="px-1 gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.5rem,2cqh,1.25rem)] mt-[clamp(0.25rem,1.5cqh,1rem)] mb-[clamp(0.1rem,1cqh,0.5rem)]">1.1 Abstract & Business Context</h4>
                      <p className="text-[clamp(0.4rem,1.6cqh,1rem)] leading-[clamp(0.6rem,2cqh,1.6rem)] mb-[clamp(0.25rem,1.5cqh,1rem)] text-justify first-letter:text-3xl first-letter:font-['Playfair_Display'] first-letter:float-left first-letter:mr-2 first-letter:mt-1">
              ...
              <Page number={4}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.55rem,1.8cqh,1rem)] mb-[clamp(0.15rem,1cqh,0.5rem)] mx-2 text-center">1.2 System Architecture</h4>
                  <div className="px-1 flex flex-col items-center justify-center mt-8">
                    <pre className="font-mono bg-[#8b7355]/5 border border-[#8b7355]/20 p-[clamp(0.25rem,2cqh,1.5rem)] shadow-sm w-[95%] mx-auto flex justify-center text-left" style={{ fontSize: '8.5px', lineHeight: '1.4' }}>
{`+-------------------------------------------------------------+
|                     CLIENT LAYER (SPA)                      |
...
+-------------------------------------------------------------+`}
              ...
              <Page number={5}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.5rem,2cqh,1.25rem)] mt-[clamp(0.25rem,1.5cqh,1rem)] mb-[clamp(0.1rem,1cqh,0.5rem)] mx-2 text-center">1.3 Detailed Component Inventory</h4>
                  <div className="px-1">
                  ...
                  <h3 className="text-[clamp(0.6rem,3cqh,1.5rem)] leading-tight mb-[clamp(0.25rem,1.5cqh,1rem)] font-['Playfair_Display'] font-bold uppercase tracking-widest border-b border-[#8b7355]/30 pb-2 text-center mx-4 mt-6">
                    2. Technical Specifications
                  </h3>
                  <p className="text-[clamp(0.4rem,1.6cqh,1rem)] leading-[clamp(0.6rem,2cqh,1.6rem)] mb-[clamp(0.25rem,1.5cqh,1rem)] text-justify px-1">
              ...
              <Page number={6}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.55rem,1.8cqh,1rem)] mb-[clamp(0.15rem,1cqh,0.5rem)] mx-2">2.1 Schema Architecture</h4>
                  <div className="px-1 space-y-3">
                    <div>
                      <p className="font-bold text-[10px] mb-1">1. User Entity Schema</p>
                      <pre className="text-[8px] leading-snug font-mono bg-[#8b7355]/5 border border-[#8b7355]/20 p-[clamp(0.25rem,2cqh,1.5rem)] whitespace-pre-wrap break-words">
...
{`const feedbackSchema = new mongoose.Schema({
  ...
  comments:       { type: String, required: true }
              ...
              <Page number={8}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.5rem,2cqh,1.25rem)] mt-[clamp(0.25rem,1.5cqh,1rem)] mb-[clamp(0.1rem,1cqh,0.5rem)] mx-2 pt-3 text-center">2.2 REST API Specification</h4>
                  <div className="px-1">
              ...
              <Page number={9}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  ...
                  <div className="px-1 gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.5rem,2cqh,1.25rem)] mt-[clamp(0.25rem,1.5cqh,1rem)] mb-[clamp(0.1rem,1cqh,0.5rem)]">3.1 Serverless Connection Pooling</h4>
                      <p className="text-[clamp(0.4rem,1.6cqh,1rem)] leading-[clamp(0.6rem,2cqh,1.6rem)] mb-[clamp(0.25rem,1.5cqh,1rem)] text-justify">
  ...
  return cachedDb;
              ...
              <Page number={10}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <div className="px-1 gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.5rem,2cqh,1.25rem)] mt-[clamp(0.25rem,1.5cqh,1rem)] mb-[clamp(0.1rem,1cqh,0.5rem)]">3.2 Wallet Sync Engine</h4>
                      <p className="text-[clamp(0.4rem,1.6cqh,1rem)] leading-[clamp(0.6rem,2cqh,1.6rem)] mb-[clamp(0.25rem,1.5cqh,1rem)] text-justify">
  ...
  userId: user._id, type: "debit", amount: totalAmount
                ...
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <div className="px-1 gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col">
                    <div>
                      ...
                      <p className="text-[clamp(0.4rem,1.6cqh,1rem)] leading-[clamp(0.6rem,2cqh,1.6rem)] mb-[clamp(0.25rem,1.5cqh,1rem)] text-[#5c4d3c] text-justify">
              ...
              <Page number={13}>
                <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <div className="px-1 gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-sm mb-[clamp(0.1rem,0.5cqh,0.25rem)] mt-2">4.4 Web Vitals Benchmarks</h4>
                      <table className="w-full text-[9px] border-collapse border border-[#8b7355]/30 text-left">
                        <tbody className="divide-y divide-[#8b7355]/20">
                  ...
                  <h3 className="text-[clamp(0.6rem,3cqh,1.5rem)] leading-tight mb-[clamp(0.25rem,1.5cqh,1rem)] font-['Playfair_Display'] font-bold uppercase tracking-widest border-b border-[#8b7355]/30 pb-2 text-center mx-4 mt-8">
...
{`{
  ...
  "builds": [
    ...
    { "src": "frontend/**", "use": "@vercel/static" }
              ...
              <Page number={14}>
                <div className="h-full flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.6rem,2cqh,1.125rem)] mb-[clamp(0.2rem,1cqh,1rem)] text-center uppercase tracking-widest border-b border-[#8b7355]/30 pb-2">5.2 Security Assessment</h4>
                  <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col px-1">
                    <p className="text-[clamp(0.5rem,1.5cqh,0.7rem)] text-[#5c4d3c] text-center mb-[clamp(0.15rem,1cqh,0.5rem)] italic">
                      Zero-trust architecture ensuring data integrity and defense-in-depth across the platform.
                    </p>
                    <div className="bg-[#8b7355]/5 text-[#2c241b] p-[clamp(0.4rem,2cqh,1rem)] rounded-lg border border-[#8b7355]/20 shadow-md">
                      <div className="font-mono text-[clamp(0.5rem,1.5cqh,0.75rem)] font-bold text-emerald-700 tracking-wider uppercase border-b border-[#8b7355]/30 pb-[clamp(0.1rem,0.5cqh,0.25rem)] mb-2">
                        Transport Security
                      </div>
                      <div className="text-[clamp(0.5rem,1.5cqh,0.7rem)] font-sans text-[#5c4d3c]">
                    ...
                    <div className="bg-[#8b7355]/5 text-[#2c241b] p-[clamp(0.4rem,2cqh,1rem)] rounded-lg border border-[#8b7355]/20 shadow-md">
                      ...
                      <div className="text-[clamp(0.5rem,1.5cqh,0.7rem)] font-sans text-[#5c4d3c] mb-2">
              ...
              <Page number={15}>
                <div className="h-full flex flex-col pt-[clamp(0.15rem,1cqh,0.5rem)]">
                  <h4 className="font-['Playfair_Display'] font-bold text-[clamp(0.6rem,2cqh,1.125rem)] mb-[clamp(0.2rem,1cqh,1rem)] text-center uppercase tracking-widest border-b border-[#8b7355]/30 pb-2">5.3 Order Lifecycle State</h4>
                  <div className="flex-1 px-1 flex flex-col justify-center gap-2">
                    <div className="bg-[#8b7355]/5 text-[#2c241b] p-[clamp(0.4rem,1.5cqh,0.875rem)] rounded-lg border border-[#8b7355]/20 shadow-md text-center">
                      <div className="font-mono text-[clamp(0.5rem,1.6cqh,0.75rem)] font-bold text-[#1a1510] tracking-[0.15em] uppercase mb-1.5">
                        1. SCHEDULED
                      </div>
                      <div className="text-[clamp(0.5rem,1.5cqh,0.7rem)] text-[#5c4d3c] font-serif italic leading-relaxed px-2">
                        The default state when a new order is created.
                      </div>
                    </div>
                    <div className="flex justify-center text-[#8b7355] font-bold text-lg">↓</div>
                    <div className="bg-[#8b7355]/5 text-[#2c241b] p-[clamp(0.4rem,1.5cqh,0.875rem)] rounded-lg border border-amber-700/30 shadow-md text-center">
                      <div className="font-mono text-[clamp(0.5rem,1.6cqh,0.75rem)] font-bold text-amber-700 tracking-[0.15em] uppercase mb-1.5">
                        2. PROCESSING
                      </div>
                      <div className="text-[clamp(0.5rem,1.5cqh,0.7rem)] text-[#5c4d3c] font-serif italic leading-relaxed px-2">
                    ...
                    <div className="flex justify-center text-[#8b7355] font-bold text-lg">↓</div>
                    <div className="bg-[#8b7355]/5 text-[#2c241b] p-[clamp(0.4rem,1.5cqh,0.875rem)] rounded-lg border border-emerald-700/30 shadow-md text-center">
                      <div className="font-mono text-[clamp(0.5rem,1.6cqh,0.75rem)] font-bold text-emerald-700 tracking-[0.15em] uppercase mb-1.5">
                        3. COMPLETED
                      </div>
                      <div className="text-[clamp(0.5rem,1.5cqh,0.7rem)] text-[#5c4d3c] font-serif italic leading-relaxed px-2">
                    ...
                    <div className="bg-[#8b7355]/5 text-[#2c241b] p-[clamp(0.4rem,1.5cqh,0.875rem)] rounded-lg border border-rose-700/30 shadow-md text-center">
                      <div className="font-mono text-[clamp(0.5rem,1.6cqh,0.75rem)] font-bold text-rose-700 tracking-[0.15em] uppercase mb-1.5">
                        4. CANCELLED
                      </div>
                      <div className="text-[clamp(0.5rem,1.5cqh,0.7rem)] text-[#5c4d3c] font-serif italic leading-relaxed px-2">
              ...
              <Page number={16}>
                <div className="h-full flex flex-col pt-2 justify-center pb-12">
                  <div className="bg-[#8b7355]/5 text-[#2c241b] p-5 rounded-lg border border-[#8b7355]/20 shadow-xl relative overflow-hidden">
                    ...
                    <div className="gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col font-sans text-[clamp(0.5rem,1.5cqh,0.75rem)] leading-relaxed text-[#5c4d3c]">
                      <p>
              ...
              <Page number={17}>
                <div className="h-full flex flex-col items-center justify-center text-center gap-[clamp(0.2rem,1.5cqh,1rem)] flex flex-col pb-12">
              ...
              <Page number={18}>
                <div className="h-full flex flex-col items-center justify-center text-center px-4 pb-12">
                  <div className="w-full max-w-[240px]">
                    <h3 className="text-[clamp(0.55rem,1.8cqh,1rem)] font-['Playfair_Display'] font-bold uppercase tracking-[0.2em] text-[#1a1510] mb-6 pb-2 border-b border-[#8b7355]/30">
                      PROJECT LINKS
                    </h3>
                    <div className="flex flex-col gap-[clamp(0.4rem,1.5cqh,0.875rem)] w-full">
                      <a
          ...
          <div className="w-full flex items-center justify-center gap-[clamp(0.4rem,2cqh,1rem)] py-4 z-[110]">
            <div className="flex gap-[clamp(0.4rem,2cqh,1rem)] bg-[#f4ebd8] p-1.5 px-3 rounded-full border border-[#8b7355] shadow-xl">
              <button 
