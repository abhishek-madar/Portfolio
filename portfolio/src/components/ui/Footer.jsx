export default function Footer() {
  return (
    <footer 
      className="w-full py-8 border-t border-brand-charcoal/10/50 dark:border-brand-offwhite/10/50 bg-brand-offwhite dark:bg-brand-charcoal relative z-10 transition-colors"
