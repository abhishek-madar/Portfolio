...
import cardGLB from '../glb/identity-badge.glb';
          ...
          <group
            ...
            onPointerUp={e => {
              ...
              if (card.current) {
                ...
                const stretch = Math.sqrt(pos.x * pos.x + pos.z * pos.z);
                if (stretch > 1.5) {
                  card.current.setAngvel({
                    x: (Math.random() - 0.5) * stretch * 2,
                    y: Math.sign(pos.x || 1) * (10 + stretch * 5),
                    z: (Math.random() - 0.5) * stretch * 2
                  }, true);
                }
              }
            }}
