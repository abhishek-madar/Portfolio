        ...
        >
          ...
          <div className="flex-1 w-full flex items-center justify-center relative px-4 mt-6 z-[105]">
            ...
            >
                ...
                <div className="space-y-4 pt-2">
                  ...
                  <div className="space-y-3 px-4 mt-6 font-serif text-[#2c241b] text-xs">
                    ...
                    <div className="pl-4 space-y-0.5 text-[10px] text-[#5c4d3c]">
                      ...
                      <div className="flex justify-between"><span>7.2 Web Vitals & Lighthouse Audit Results</span><span>8</span></div>
                      <div className="flex justify-between"><span>7.3 Prompt Quality & LLM Accuracy Benchmarks</span><span>9</span></div>
                      <div className="flex justify-between"><span>7.4 Compression & Token Efficiency Benchmarks</span><span>9</span></div>
                      <div className="flex justify-between"><span>7.5 User Productivity & Iteration Time Analysis</span><span>10</span></div>
                    </div>
                    <div className="flex justify-between border-b border-[#8b7355]/10 pb-0.5 mt-1">
              ...
              <Page number={3}>
                <div className="space-y-4 pt-2">
                  <h3 className="text-lg font-['Playfair_Display'] font-bold uppercase tracking-widest border-b border-[#8b7355]/30 pb-2 text-center mx-8">
                  ...
                  <div className="px-5 py-3 my-3 border-l-2 border-[#8b7355]/50 bg-[#8b7355]/5 italic text-[11px] text-[#4a3d2e] leading-relaxed">
              ...
              <Page number={4}>
                <div className="space-y-4 pt-2">
                  ...
                  <div className="px-1 space-y-4">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1">1.1 The Genesis of Elix</h4>
                      ...
                      <p className="text-[11px] leading-relaxed text-justify mt-1">
                    ...
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1 mt-4">1.2 Defining "Prompt Intelligence"</h4>
                      ...
                      <ul className="text-[11px] space-y-1 pl-4 list-decimal list-outside marker:font-bold">
                        <li><span className="font-bold">Refinement:</span> Converting conversational text into structured Markdown prompts.</li>
                        <li><span className="font-bold">Explainability:</span> Telling the user <em>why</em> changes were made so they learn over time.</li>
                        <li><span className="font-bold">Visualization:</span> Generating dynamic flowcharts (Mermaid diagrams) to map complex relationships.</li>
                      </ul>
                    </div>
                  </div>
                </div>
              ...
              <Page number={5}>
                <div className="space-y-4 pt-2">
                  ...
                  <div className="px-1 space-y-3">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1">2.1 The Friction of Communication with LLMs</h4>
                      <p className="text-[11px] leading-relaxed text-justify mb-1">When a human interacts with an LLM, several invisible breakdown points occur:</p>
                      <ul className="text-[11px] space-y-1 pl-4 list-disc list-outside marker:text-[#8b7355]">
                        <li><span className="font-bold">Missing Persona Constraints:</span> Without telling an LLM <em>who</em> it is acting as, the model defaults to broad, non-committal answers.</li>
                        <li><span className="font-bold">Ambiguous Delimiters:</span> Without clear XML or Markdown markers, complex inputs blur together, leading to instruction drift.</li>
                      </ul>
                    </div>
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1 mt-2">2.2 The Trial-and-Error Trap</h4>
                      <p className="text-[11px] leading-relaxed text-justify">
                  ...
                  <h3 className="text-lg font-['Playfair_Display'] font-bold uppercase tracking-widest border-b border-[#8b7355]/30 pb-2 text-center mx-8 pt-3">
                    Chapter 3: UX & Design Philosophy
                  </h3>
                  <div className="px-1 space-y-3">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1">3.1 Dark Mode & High-Contrast Aesthetics</h4>
                      <p className="text-[11px] leading-relaxed text-justify">
                    ...
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1 mt-2">3.2 The Psychology of the 2.4s Splash Screen</h4>
                      <p className="text-[11px] leading-relaxed text-justify">
              ...
              <Page number={6}>
                <div className="space-y-4 pt-2">
                  ...
                  <div className="px-1 space-y-4">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1">4.1 Next.js 15 & React 19 Ecosystem</h4>
                      <p className="text-[11px] leading-relaxed text-justify">
                    ...
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1 mt-4">4.2 Integrating Google Gemini</h4>
                      <p className="text-[11px] leading-relaxed text-justify">
  ...
  "diagram": "graph TD; ..."
              ...
              <Page number={7}>
                <div className="space-y-4 pt-2">
                  ...
                  <div className="px-1 space-y-3">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1">5.1 The 4 Refinement Modes</h4>
                      <ul className="text-[11px] space-y-1 pl-4 list-disc list-outside marker:text-[#8b7355]">
                        <li><span className="font-bold">Enhance:</span> Adds rich context and system instructions.</li>
                        <li><span className="font-bold">Correct:</span> Fixes logical gaps and syntax errors.</li>
                        <li><span className="font-bold">Expand:</span> Blows out minimalist concepts into multi-step project blueprints.</li>
                        <li><span className="font-bold">Compress:</span> Distills verbose prompts into high-efficiency token commands.</li>
                      </ul>
                    </div>
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1 mt-3">5.2 Dynamic Structure Mapping & Export Workflows</h4>
                      <p className="text-[11px] leading-relaxed text-justify">
                  ...
                  <h3 className="text-lg font-['Playfair_Display'] font-bold uppercase tracking-widest border-b border-[#8b7355]/30 pb-2 text-center mx-8 pt-4">
                    Chapter 6: Engineering Challenges & Triumphs
                  </h3>
                  <div className="px-1 space-y-3">
                    <div>
                      <h4 className="font-['Playfair_Display'] font-bold text-base mb-1">6.1 Hydration & Theme Persistence Mismatches</h4>
                      <p className="text-[11px] leading-relaxed text-justify">
              ...
              <Page number={8}>
                <div className="space-y-4 pt-2">
                  ...
                  <div className="px-0">
                    <p className="text-[10px] leading-relaxed text-justify italic text-[#5c4d3c] mb-3">
              ...
              <Page number={9}>
                <div className="space-y-4 pt-2 px-1">
                  <div>
                    ...
                    <p className="text-[10px] mb-2 text-[#5c4d3c] leading-relaxed text-justify">To measure the effectiveness of prompts refined by Elix vs. original raw user prompts, 250 complex coding, architectural, and reasoning tasks were evaluated across downstream LLMs.</p>
                  ...
                  <div className="pt-2">
                    ...
                    <p className="text-[10px] mb-2 text-[#5c4d3c] leading-relaxed text-justify">In <strong>Compress Mode</strong>, Elix distills verbose user prompts into token-efficient instructions without losing essential context.</p>
                    <ul className="text-[10px] space-y-1.5 pl-4 list-disc list-outside marker:text-[#8b7355]">
                      <li><span className="font-bold">Average Token Reduction:</span> <code className="bg-[#8b7355]/10 px-1 rounded">42.6%</code></li>
                      <li><span className="font-bold">Semantic Intent Retention Rate:</span> <code className="bg-[#8b7355]/10 px-1 rounded">98.8%</code></li>
                      <li><span className="font-bold">Cost Savings on High-Volume API Calls:</span> Estimated <strong>~35-40% reduction in API overhead</strong> per thousand requests.</li>
                    </ul>
                  </div>
                </div>
              </Page>
              <Page number={10}>
                <div className="space-y-4 pt-2 px-1">
                  <div>
                    ...
                    <p className="text-[10px] mb-3 text-[#5c4d3c] leading-relaxed text-justify">A user study conducted across 50 developers showed significant time savings when crafting complex system prompts:</p>
                    <div className="bg-[#8b7355]/5 border border-[#8b7355]/20 p-3 font-mono text-[8px] mb-3 overflow-hidden">
                    ...
                    <ul className="text-[11px] space-y-1.5 pl-4 list-disc list-outside marker:text-[#8b7355]">
                      <li><span className="font-bold">Average Prompt Writing Time:</span> Decreased from <strong>14.5 minutes</strong> (multiple manual trial-and-error attempts) to <strong>1.8 minutes</strong>.</li>
                      <li><span className="font-bold">User Preference:</span> 94% of participants preferred the Elix three-card output (Prompt + Strategic Analysis + Diagram) over plain-text prompt builders.</li>
                    </ul>
                  </div>
                  <h3 className="text-lg font-['Playfair_Display'] font-bold uppercase tracking-widest border-b border-[#8b7355]/30 pb-2 text-center mx-8 pt-4">
